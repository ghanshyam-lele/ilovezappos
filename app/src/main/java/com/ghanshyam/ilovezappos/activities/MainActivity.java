...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        TextView t= (TextView) badgeLayout.findViewById(R.id.actionbar_notifcation_textview);
        t.setText("0");
        GlobalData.setCartBadge(t);
        GlobalData.setContext(this);
        GlobalData.setGlobalCartSize(0);
       // GlobalData.updateCart(0);
        //GlobalData.setGlobalCartSize(0);
